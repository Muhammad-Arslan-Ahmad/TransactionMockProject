...
const TRANSACTION = [
  {
    ...
    transactions: [
      ...
      {
        id: "93a5ce2a5a82873607f3917514a31be53b437ac0e8dc459db770e6d1ebd72a751c1d",
        date: "2018-07-01",
        description: "Wilko",
        category_title: "Shopping",
        amount: {
      ...
      {
        id: "34f786f9548a3a8dff4d1189f76500b2737e917d5c3996afe70bfd88143bf9efca60",
        date: "2018-07-03",
      ...
      {
        id: "9789225426e4fa222074b729ac6e0bbfe8fb6dbbec1d21a9ee748f24c8768e9f352b",
        date: "2018-07-03",
        description: "Tesco",
        category_title: "Groceries",
        amount: {
      ...
      {
        id: "0efaa570e745c444e2fcb7b995972a48555a7d962b1bef7ca386891678533382721c",
        date: "2018-07-02",
      ...
      {
        id: "c8e306c2a62c98e6fb3eef925f627ba940c8beebca3ac14ac911b36fd10fb9c0a84a",
        date: "2018-07-01",
        description: "Asda",
        category_title: "Shopping",
        amount: {
      ...
      {
        id: "655202211331ea3897c81b0667971311360d457eed535e653c6126711b7a1f1d3d35",
        date: "2018-07-01",
...
describe("Smallest Expenses", () => {
  it("renders the landing page successfully", () => {
    render(<App />);
  });

  it("returns api correct response", async () => {
    axios.get.mockResolvedValue({ data: TRANSACTION });
    render(<App />);
    const transaction = await waitFor(() => screen.findAllByTestId("bud"));
    expect(transaction).toHaveLength(1);
  });

  it("return error when transcation is null", async () => {
    axios.get.mockResolvedValue({ data: EMPTY_TRANSACTION });
    render(<App />);
    const transaction = await waitFor(() =>
      screen.findAllByTestId("emptyTransaction")
    );
    expect(transaction).toBeDefined();
  });

  it("returns error when url is not correct or empty ", async () => {
    axios.get.mockResolvedValue({ data: {} });
    render(<App />);
    const transaction = await waitFor(() => screen.findAllByTestId("error"));
    expect(transaction).toBeDefined();
  });
});
